...
def test_mask_account_card_parametrize(enter_value, expected_result):
    """Проверяяем что функция корректно распознает и применяет тип маскировки, корректно работает с разными типами карт и счетов и с некорректными данными."""
    assert mask_account_card(enter_value) == expected_result


@pytest.mark.parametrize("enter_value, expected_result", [("2018-07-11T02:26:18.671407", "11.07.2018"), ("0000-00-00T02:26:18.671407", "Некорректная дата!"), ("", "Некорректная дата!"), (" ", "Некорректная дата!"), ("4563453263453252", "Некорректная дата!"), ("2025-03-11T02:26:18.671407", "Некорректная дата!")])
def test_get_data_parametrize(enter_value, expected_result):
    """ Проверяем правильность преобразования даты, работу функции на различных входных форматах, в том числе отсутствие даты """
